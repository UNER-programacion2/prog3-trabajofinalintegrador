...
export default class reservasDb{
    ...
    postReserva = async ({fecha_reserva, salon_id, usuario_id,turno_id,foto_cumpleaniero,tematica,importe_salon,importe_total }) =>{
        
        try {
            console.log("Valores de reserva antes del insert:", {
  fecha_reserva,
  salon_id,
  usuario_id,
  turno_id,
  ...
  importe_total
    ...
    putReserva = async (reserva_id,{fecha_reserva, salon_id, usuario_id,turno_id,foto_cumpleaniero,tematica,importe_salon,importe_total }) =>{ 
        const sql = `
        UPDATE reservas
